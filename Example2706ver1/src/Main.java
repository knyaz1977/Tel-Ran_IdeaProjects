public class Main {
    ...
    public static void main(String[] args) {
        // Write a method that takes a String and a two chars. As the
        // result it returns the given String, where each the first char
        // was replaced by the second char. You have to use only length()
        // and charAt() methods of String class.For example:
        ...
        // Write method that checks whether a given string is a palindrome. A palindrome is
        // a phrase that reads the same from the front and the back.
        System.out.println(isPalindrom("1234321"));
        System.out.println(isPalindrom("12341"));

        // Implement a method that returns the index of the biggest element of a given
        // array of int{10, 33, 3, 5, -9} -> 1
        int[] array = {10, 33, 3, 5, -9};
        System.out.println(indexOfMaxElement(array));

        // Implement a method that returns the sum of elements of the given array of
        // int{10, 3, 23, 5, -9} -> 32
