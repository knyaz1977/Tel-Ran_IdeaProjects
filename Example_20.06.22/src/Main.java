...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The sum of all numbers between number1 and number2 that divisible by 3 is " + SumDivisibleByTreeNumbersted(number1, number2));
    }

    private static int SumDivisibleByTreeNumbersted(int number1, int number2) {
