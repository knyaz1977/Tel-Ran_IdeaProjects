...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Task6
        // Второй уровень: Напишите метод, который присваивает переменной случайное значение из диапазона с плавающей
        // запятой и выводит данные, округленные до 3 знаков после запятой.
        task6();
    ...
    // если нужно сгенерировать случайное число в диапозоне от А до B то формулу нужно использовать
    // (B - A) * Math.random() + A

    private static void  task6() {
        double a = Math.random(); // генерирует случайное число от 0 до 1 (не включая)
        System.out.println(String.format("%.3f", a));
        double a1 = 100 * Math.random(); // от 0 до 100
        // A = 10, B = 20 -> 10 * Math.random() + 10
        double a2 = 10 * Math.random() + 10; // от 10 до 20


        System.out.println(a2); // неформатированный вывод
        System.out.println(String.format("%.3f", a2)); // форматированный вывод
